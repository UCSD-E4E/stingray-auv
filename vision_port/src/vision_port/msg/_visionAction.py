"""autogenerated by genpy from vision_port/visionAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import vision_port.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class visionAction(genpy.Message):
  _md5sum = "8c1d51495ec77c696fffbfeb0811ad0a"
  _type = "vision_port/visionAction"
...
"""
  ...
  _slot_types = ['vision_port/visionActionGoal','vision_port/visionActionResult','vision_port/visionActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(visionAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = vision_port.msg.visionActionGoal()
      if self.action_result is None:
        self.action_result = vision_port.msg.visionActionResult()
      if self.action_feedback is None:
        self.action_feedback = vision_port.msg.visionActionFeedback()
    else:
      self.action_goal = vision_port.msg.visionActionGoal()
      self.action_result = vision_port.msg.visionActionResult()
      self.action_feedback = vision_port.msg.visionActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_goal.goal.task, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.action_feedback.feedback.subtask))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.task, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.subtask,) = _struct_i.unpack(str[start:end])
      return self
