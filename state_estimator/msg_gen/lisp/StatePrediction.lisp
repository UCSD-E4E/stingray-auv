...
;//! \htmlinclude StatePrediction.msg.html

(cl:defclass <StatePrediction> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass StatePrediction (<StatePrediction>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <StatePrediction>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'StatePrediction)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name state_estimator-msg:<StatePrediction> is deprecated: use state_estimator-msg:StatePrediction instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <StatePrediction>))
...
(cl:defmethod lat-val ((m <StatePrediction>))
...
(cl:defmethod lon-val ((m <StatePrediction>))
...
(cl:defmethod depth-val ((m <StatePrediction>))
...
(cl:defmethod roll-val ((m <StatePrediction>))
...
(cl:defmethod pitch-val ((m <StatePrediction>))
...
(cl:defmethod yaw-val ((m <StatePrediction>))
...
(cl:defmethod surge-val ((m <StatePrediction>))
...
(cl:defmethod sway-val ((m <StatePrediction>))
...
(cl:defmethod heave-val ((m <StatePrediction>))
...
(cl:defmethod surge_dot-val ((m <StatePrediction>))
...
(cl:defmethod sway_dot-val ((m <StatePrediction>))
...
(cl:defmethod heave_dot-val ((m <StatePrediction>))
...
(cl:defmethod mag_x-val ((m <StatePrediction>))
...
(cl:defmethod mag_y-val ((m <StatePrediction>))
...
(cl:defmethod mag_z-val ((m <StatePrediction>))
  ...
  (mag_z m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <StatePrediction>) ostream)
  "Serializes a message object of type '<StatePrediction>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <StatePrediction>) istream)
  "Deserializes a message object of type '<StatePrediction>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StatePrediction>)))
  "Returns string type for a message object of type '<StatePrediction>"
  "state_estimator/StatePrediction")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StatePrediction)))
  "Returns string type for a message object of type 'StatePrediction"
  "state_estimator/StatePrediction")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<StatePrediction>)))
  "Returns md5sum for a message object of type '<StatePrediction>"
  "a14638f1c8add4a6304fb5fa95c6157c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'StatePrediction)))
  "Returns md5sum for a message object of type 'StatePrediction"
  "a14638f1c8add4a6304fb5fa95c6157c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<StatePrediction>)))
  "Returns full string definition for message of type '<StatePrediction>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'StatePrediction)))
  "Returns full string definition for message of type 'StatePrediction"
  (cl:format cl:nil "Header header~%float32 lat~%float32 lon~%float32 depth ~%float32 roll ~%float32 pitch~%float32 yaw~%float32 surge~%float32 sway~%float32 heave~%float32 surge_dot~%float32 sway_dot~%float32 heave_dot~%float32 mag_x~%float32 mag_y~%float32 mag_z~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <StatePrediction>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <StatePrediction>))
  "Converts a ROS message object to a list"
  (cl:list 'StatePrediction
