"""autogenerated by genpy from vision_port/visionActionResult.msg. Do not edit."""
import sys
...
class visionActionResult(genpy.Message):
  _md5sum = "3d669e3a63aa986c667ea7b0f46ce85e"
  _type = "vision_port/visionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','vision_port/visionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(visionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = vision_port.msg.visionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = vision_port.msg.visionResult()
